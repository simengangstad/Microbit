...
void twi_read(uint8_t slave_address, uint8_t start_register, uint8_t registers_to_read, uint8_t * data_buffer) {
	while(1) {
		uint8_t success = twi_read_with_watchdog(slave_address, start_register, registers_to_read, data_buffer);
...
void twi_write(uint8_t slave_address, uint8_t start_register, uint8_t registers_to_write, uint8_t * data_buffer) {
	while(1) {
		uint8_t success = twi_write_with_watchdog(slave_address, start_register, registers_to_write, data_buffer);
